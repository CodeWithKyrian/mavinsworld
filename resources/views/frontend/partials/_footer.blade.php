                ...
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        <div class="newsletter-content">
                            ...
                            <p class="mb-45">Start Your Daily Shopping with <span class="text-brand">Marvins
                                    World</span></p>
            ...
            <div class="row">
                    ...
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="logo mb-30">
                            <a href="index.html" class="mb-15"><img src="/img/mavinsworld.png"
                                    alt="logo" /></a>
                            <p class="font-lg text-heading">Let's help you restore your sexual confidence</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-link-widget  col wow animate__animated animate__fadeInUp"
                    ...
                    <ul class="contact-infor">
                        ...
                        <li><img src="/img/theme/icons/icon-email-2.svg"
                                alt="" /><strong>Email: </strong><span>support@marvinsworld.com</span></li>
                    </ul>
                </div>
            </div>
    </section>
