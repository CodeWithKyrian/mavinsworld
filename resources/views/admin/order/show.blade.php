    ...
    <div class="card">
        <header class="card-header">
            <div class="row align-items-center">
                ...
                <form method="POST" action="{{route('admin.order.update', $order)}}" class="col-lg-6 col-md-6 ms-auto text-md-end">
                    @csrf
                    @method('PUT')
                    ...
                    <button class="btn btn-secondary print ms-2" type="button"><i class="icon material-icons md-print"></i></button>
                </div>
            </div>
        </header>
        <!-- card-header end// -->
                                    ...
                                    <td colspan="4">
                                        <article class="float-end">
                                            ...
                                            <dl class="dlist">
                                                <dt>Grand total:</dt>
                                                <dd><b
                                                        class="h5">{{ format_price($order->grand_total) }}</b>
                                                </dd>
                                            </dl>
                                            <dl class="dlist">
